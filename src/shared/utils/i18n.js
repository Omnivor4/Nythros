export const dict = {
  en: {
    ...
    endpointError: "Failed to connect to Endpoint. Please check your Base URL and API Key using: nythros config set",
  ...
  id: {
    ...
    endpointError: "Gagal terhubung ke Endpoint. Cek lagi Base URL dan API Key kamu lewat perintah: nythros config set",
    ...
    replWelcome: "Selamat datang di Nythros REPL! (Ketik 'exit' untuk keluar, 'clear' untuk hapus layar)",
    replPrompt: "Kamu: ",
    replAgentPrefix: "Nythros: ",
    replThinking: "Mikir...",
